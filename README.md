...
<div align="center">
  <!-- Hero Section -->
  <img src="assets/hero.svg" width="800" alt="Nico // Alonezdb" />
  
  <br/>
  
  <!-- Typing Animation -->
  <img src="assets/typing.svg" width="600" alt="Typing Animation" />
...
<table width="800" border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse: collapse; border: none; margin: 0 auto;">
  <tr style="border: none;">
    <td width="380" valign="top" style="border: none; padding: 10px;">
      ...
      <p style="font-family: -apple-system, BlinkMacSystemFont, 'Outfit', 'Segoe UI', sans-serif; font-size: 14px; color: #a1a1aa; line-height: 1.6; margin-bottom: 16px;">
      ...
      <p style="font-family: -apple-system, BlinkMacSystemFont, 'Outfit', 'Segoe UI', sans-serif; font-size: 14px; color: #a1a1aa; line-height: 1.6; margin-bottom: 20px;">
    ...
    <td width="380" valign="top" style="border: none; padding: 10px;">
      <img src="assets/terminal.svg" width="380" style="display: block;" alt="Terminal Animation" />
    </td>
  </tr>
</table>
...
<div align="center">
  ...
  <img src="assets/glass-card.svg" width="800" alt="Glass Cards Showcase" />
</div>
